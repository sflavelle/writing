...
Think of this work's interpretation of the multiverse and the placement of particular universes as a quadrant chart, where the X axis grades "Logic Basis" and the Y axis grades "Supernatural Force" (see definitions for these below). Similarly-operating universes will generally be placed nearby each other.
...
Time Flow: How does Time as a concept manifest? (scale: Linear ... Fluid (Forward/Backward/Stopped) ... Timey-Wimey (Loops, timeline collisions,rewriting history))
Life Force: How healthiness/"life energy" is represented in the universe, and how injuries and 'damage' affect that life energy. Universes might sometimes treat 'life' and 'damage' separately on the scale. (scale: Cartoon-ish ... HP (numbers) ... HP (bars / 'hits') ... Movie Logic ... Realistic)
...
Quirks:
 ...
 - Also where Undertale's former royal scientist W.D. Gaster is trapped ("scattered across time and space").
...
Time Flow: Fluid (Saves/Resets)
Life Force: HP (numbers)
Logic Basis: Natural (Sans: Rule of Funny) (Yes, Sans the Skeleton is normally bound by the logic of "what would be the funniest thing to do here")
Supernatural Force: Magical Society (eg. Monsters)

Red Dwarf:
Physics: Realistic
Time Flow: Timey-Wimey ('The Inquisitor' and 'Timeslides' episodes show timelines and histories being overwritten)
